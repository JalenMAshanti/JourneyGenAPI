...
namespace JSMS.Persitence.Repositories
{
    public class LoginRepository : ILoginRepository
    {
        ...
        {
            string? sql = "SELECT Id, FirstName, LastName, Gender, Email, RoleId, GroupId, Grade, PhoneNumber, Password, ReadingStreak FROM user WHERE Email = @Email AND Password = @Password";
